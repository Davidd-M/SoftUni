...
CREATE TABLE IF NOT EXISTS players_ranges(
	id SERIAL PRIMARY KEY,
	min_players INT NOT NULL, -- CHECK
	max_players INT NOT NULL, -- CHECK

	CONSTRAINT ck_min_players_is_postive
		CHECK (min_players > 0),
	CONSTRAINT ck_max_players_is_postive
		CHECK (max_players > 0)
);
...
CREATE TABLE IF NOT EXISTS board_games(
	...
	category_id INT NOT NULL, -- RELATES
	publisher_id INT NOT NULL, -- RELATES
	players_range_id INT NOT NULL, -- RELATES
...
CREATE TABLE IF NOT EXISTS creators_board_games(
	creator_id INT NOT NULL, -- RELATES
	board_game_id INT NOT NULL, -- RELATES
