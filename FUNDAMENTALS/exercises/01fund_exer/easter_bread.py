...
Flour 1 kg
Milk 0.250 l
First, you will receive your budget. Then, you will receive the price for 1 kg flour. The price for 1 pack of eggs is 75%
of the price for 1 kg flour. The price for 1L milk is 25% more than the price for 1 kg flour. Keep in mind that you use
only 250ml milk for a bread.
...
price_eggs_pack = price_kg_flour * 0.75
price_1l_milk = price_kg_flour * 1.25
one_loaf_price = price_eggs_pack + price_kg_flour + (price_1l_milk / 4)
total_loaf_price = 0
loaves = 0
eggs = 0
while True:
    total_loaf_price += one_loaf_price
    if budget < total_loaf_price:
        total_loaf_price -= one_loaf_price
        break
    loaves += 1
    eggs += 3
    if loaves % 3 == 0:
        eggs -= loaves - 2
diff = budget - total_loaf_price
print(f"You made {loaves} loaves of Easter bread! Now you have {eggs} eggs and {diff:.2f}BGN left.")